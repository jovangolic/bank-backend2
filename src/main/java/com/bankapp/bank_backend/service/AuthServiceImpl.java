...
import com.bankapp.bank_backend.repository.PasswordResetTokenRepository;
...
public class AuthServiceImpl implements AuthService {
    ...
    private boolean isExistingTokenValid(PasswordResetToken existingToken) {
        return existingToken != null && existingToken.getExpiredDateTime().isAfter(LocalDateTime.now().plusMinutes(5));
    }
